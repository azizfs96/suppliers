...
<div class="app-shell pb-24">
    <header class="ui-top-shelf ui-top-shelf--dense">
        <div class="ui-top-shelf__top">
            <div class="flex min-w-0 items-center gap-3">
                ...
                <div class="min-w-0">
                    <p class="ui-kicker">تعديل</p>
                    <h1 class="ui-page-title">تعديل وكيل</h1>
                </div>
            </div>
        </div>
    ...
    <form method="post" action="{{ route('agents.update', $agent) }}" class="ui-card space-y-5">
        @csrf
        @method('PUT')
        @include('agents._form', ['submit' => 'حفظ التغييرات'])
    </form>
</div>
@endsection
